    ...
    await queryInterface.bulkInsert(
      ...
      [
        ...
        },
        {
          ...
          aboutMe: 'профессиональный фотограф и просто красивый армянский парень',
        ...
        },
        {
          ...
          img: 'B-hITHIHTQ0.jpg',
          education: 'МГУ',
          experience: 'съемка в рекламе энергетиков',
          aboutMe: 'просто прекрасная девушка, СОМНИТЕЛЬНЫЕ ПРОЕКТЫ НЕ ПРЕДЛАГАТЬ!!',
